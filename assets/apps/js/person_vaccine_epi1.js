$(document).ready(function () {
  var dataTable = $("#table_data").DataTable({
    ...
    pageLength: 10,
    ajax: {
      url: site_url + "/person_vaccine_epi1/fetch_person_vaccine",
      data: {
...
crud.ajax = {
  del_data: function (id, cb) {
    var url = "/person_vaccine_epi1/del_person_vaccine",
      params = {
        id: id,
      };
  ...
  save: function (items, cb) {
    var url = "/person_vaccine_epi1/save_person_vaccine",
      params = {
        items: items,
      };
  ...
  get_update: function (id, cb) {
    var url = "/person_vaccine_epi1/get_person_vaccine",
      params = {
        id: id,
      };
  ...
  set_vaccine_status: function (cid, val, cb) {
    var url = "/person_vaccine_epi1/set_vaccine_status",
      params = {
        cid: cid,
        val: val,
      };
