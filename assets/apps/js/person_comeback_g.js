...
crud.ajax = {
  del_data: function (id, cb) {
    var url = "/person_comeback_g/del_person_comeback_g",
      params = {
        id: id,
      };
  ...
  save: function (items, cb) {
    var url = "/person_comeback_g/save_person_comeback_g",
      params = {
        items: items,
      };
  ...
  get_update: function (id, cb) {
    var url = "/person_comeback_g/get_person_comeback_g",
      params = {
        id: id,
      };
  ...
  sendToLine: function (sms, id, cb) {
    var url = "/person_comeback_g/sendtoline",
      params = {
        id: id,
        sms: sms,
      };
...
$(document).on("click", 'button[data-btn="btn_edit"]', function (e) {
  ...
  var id = $(this).data("id");
  $("#action").val("update");
  window.location = site_url + "/person_comeback_g/add_person_comeback_g/" + id;
});
...
$(document).on("click", 'button[data-btn="btn_files"]', function (e) {
  ...
  window.location = site_url + "/person_comeback_g/files/" + id + "/" + cid;
});
