            ...
            <div class="col-md-4">
                <section class="login-form">
                    <form method="post" action="#" role="login" id="frm_login">
                        ...
                        <input type="email" id="username" placeholder="เลขบัตรประชาชน" required class="form-control input-lg"
                            value="" />

                        <input type="password" class="form-control input-lg" id="password" placeholder="ปี พ.ศ. เกิด "
                            required="" />
                        <div class="pwstrength_viewport_progress"></div>
                        <input type="hidden" name="csrf_token" value="<?php echo $this->security->get_csrf_hash() ?>">
                    </form method="post">
                    <button name="go" class=" btn btn-lg  btn-block w3-theme-d1"
                        id="btn_login_asm">เข้าสู่ระบบ</button>
                    <div>
                ...
                <section class="login-form">
                    <div class="panel w3-theme">
                        ...
                        <div class="panel-body">
                            1.ระบบบักทึกข้อมูล กำหนดเป้าหมายวัคซีนเข็ม 3 โดย อสม.
                            <br>
                            <br>
