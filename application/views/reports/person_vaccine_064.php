...
<div class="panel panel-info">
    <div class="panel-heading">
        กลุ่มเป้าหมายฉีดวัคซีนป้องกัน COVID-19 กลุ่ม 6 เดือน -4 ปี ของจังหวัดมหาสารคาม
    </div>
    <div class="panel-body">

        <div class="navbar navbar-default">
            <form action="<?php echo site_url('report/person_vaccine_064')?>" class="navbar-form" method="post">
