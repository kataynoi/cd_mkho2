...
class Person_vaccine_epi1 extends CI_Controller
{
    public $user_id;
    public function __construct()
    {
        ...
        $this->load->model('Person_vaccine_epi1_model', 'crud');
    }
    ...
    public function index()
    {
        ...
        $this->layout->view('person_vaccine_epi1/index', $data);
    }
    ...
    function fetch_person_vaccine()
    {
        ...
        foreach ($fetch_data as $row) {
            ...
            $sub_array = array();
                ...
                $sub_array[] = $row->age_y."ปี (".$row->m." เดือน)";
               // $sub_array[] = $row->addr;
                //$sub_array[] = $row->home;
